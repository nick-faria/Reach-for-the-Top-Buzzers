    ...
    def start_new_question(self, question_type, state = 'ReaderAsking', text_to_update = dict()):
        ...
        if question_type in QUESTION_TYPES:
            ...
            if self.question_type in ['OpenTopic', 'Assign', 'Tiebreak', 'Shootout', 'Team', 'Scramble']:
                self.text_fields['show_answer_button']   = TextField(self, 0.65 , 0.2   , 0.325, 0.7  , 'No Response...', LIGHT_PURPLE, BLACK, BLACK, 'OpenSans-Regular', 42 , 'ShowAnswer'  , True , True , True , 'center', 'center')
                self.text_fields['correct_button']       = TextField(self, 0.65 , 0.2   , 0.325, 0.325, 'Correct'       , LIGHT_GREEN , BLACK, BLACK, 'OpenSans-Regular', 42 , 'Correct'     , False, True , True , 'center', 'center')
                self.text_fields['incorrect_button']     = TextField(self, 0.65 , 0.5625, 0.325, 0.325, 'Incorrect'     , LIGHT_RED   , BLACK, BLACK, 'OpenSans-Regular', 42 , 'Incorrect'   , False, True , True , 'center', 'center')
                self.text_fields['next_question_button'] = TextField(self, 0.65 , 0.2   , 0.325, 0.7  , 'Next Question' , LIGHT_YELLOW, BLACK, BLACK, 'OpenSans-Regular', 42 , 'NextQuestion', False, True , True , 'center', 'center')
            else: # WhoWhat
                self.text_fields['show_answer_button']   = TextField(self, 0.65 , 0.625, 0.325, 0.3, 'No Response...', LIGHT_PURPLE, BLACK, BLACK, 'OpenSans-Regular', 42 , 'ShowAnswer'  , False, True , True , 'center', 'center')
                self.text_fields['correct_button']       = TextField(self, 0.65 , 0.625, 0.15 , 0.3, 'Correct'       , LIGHT_GREEN , BLACK, BLACK, 'OpenSans-Regular', 42 , 'Correct'     , True , True , True , 'center', 'center')
                self.text_fields['incorrect_button']     = TextField(self, 0.825, 0.625, 0.15 , 0.3, 'Incorrect'     , LIGHT_RED   , BLACK, BLACK, 'OpenSans-Regular', 42 , 'Incorrect'   , True , True , True , 'center', 'center')
                self.text_fields['next_question_button'] = TextField(self, 0.65 , 0.625, 0.325, 0.3, 'Next Question' , LIGHT_YELLOW, BLACK, BLACK, 'OpenSans-Regular', 42 , 'NextQuestion', False, True , True , 'center', 'center')
            ...
            if self.question_type in ['OpenTopic', 'Assign', 'Tiebreak', 'Shootout', 'Team', 'Scramble']:
                ...
                self.text_fields['title']                   = TextField(self, 0.025, 0     , 0.95 , 0.12  , 'Reach for the Top'                           , None, BLACK, None , 'OpenSans-Regular', 108, None, True , False, False, 'center', 'center')
                self.text_fields['question_type_and_topic'] = TextField(self, 0.025, 0.12  , 0.6  , 0.075 , 'Open Question: '                             , None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'left'  , 'center')
                self.text_fields['points']                  = TextField(self, 0.65 , 0.12  , 0.325, 0.075 , 'Points: __'                                  , None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'right' , 'center')
                self.text_fields['question_container']      = TextField(self, 0.025, 0.2   , 0.6  , 0.1875, 'Question:'                                   , None, BLACK, BLACK, 'OpenSans-Regular', 24 , None, True , False, True , 'left'  , 'top')
                self.text_fields['question_text']           = TextField(self, 0.025, 0.25  , 0.6  , 0.1375, '...'                                         , None, BLACK, None , 'OpenSans-Regular', 14 , None, True , False, False, 'left'  , 'top')
                self.text_fields['answer_container']        = TextField(self, 0.025, 0.4125, 0.6  , 0.1875, 'Answer:'                                     , None, BLACK, BLACK, 'OpenSans-Regular', 24 , None, False, False, True , 'left'  , 'top')
                self.text_fields['answer_text']             = TextField(self, 0.025, 0.4625, 0.6  , 0.1375, '...'                                         , None, BLACK, None , 'OpenSans-Regular', 14 , None, False, False, False, 'left'  , 'top')
                self.text_fields['date_and_time']           = TextField(self, 0.65 , 0.9   , 0.325, 0.075 , datetime.now().strftime('%A, %B %d; %I:%M %p'), None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'right' , 'bottom')
                self.text_fields['basic_scores']            = TextField(self, 0.025, 0.625 , 0.6  , 0.35  , '...'                                         , None, BLACK, BLACK, 'OpenSans-Regular', 42 , None, True , False, True , 'center', 'center')
                if self.question_type == 'Scramble':
                    ## Center question field and increase font size for word scramble questions
                    self.text_fields['question_text'].horz_alignment = 'center'
                    self.text_fields['question_text'].update_font(self.text_fields['question_text'].font_name, 28)

            elif self.question_type == 'WhoWhat':
                self.text_fields['title']                   = TextField(self, 0.025, 0     , 0.95 , 0.12  , 'Reach for the Top'                           , None, BLACK, None , 'OpenSans-Regular', 108, None, True , False, False, 'center', 'center')
                self.text_fields['question_type_and_topic'] = TextField(self, 0.025, 0.525 , 0.6  , 0.075 , '___ Am I?      '                             , None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'left'  , 'center')
                self.text_fields['points']                  = TextField(self, 0.65 , 0.525 , 0.325, 0.075 , 'Points: __'                                  , None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'right' , 'center')
                self.text_fields['question_container']      = TextField(self, 0.025, 0.2   , 0.95 , 0.1875, 'Clues:'                                      , None, BLACK, BLACK, 'OpenSans-Regular', 24 , None, True , False, True , 'left'  , 'top')
                self.text_fields['question_text']           = TextField(self, 0.025, 0.25  , 0.95 , 0.1375, '...'                                         , None, BLACK, None , 'OpenSans-Regular', 14 , None, True , False, False, 'left'  , 'top')
                self.text_fields['answer_container']        = TextField(self, 0.025, 0.4125, 0.95 , 0.1875, 'Answer:'                                     , None, BLACK, BLACK, 'OpenSans-Regular', 24 , None, False, False, True , 'left'  , 'top')
                self.text_fields['answer_text']             = TextField(self, 0.025, 0.4625, 0.95 , 0.1375, '...'                                         , None, BLACK, None , 'OpenSans-Regular', 14 , None, False, False, False, 'right' , 'top')
                self.text_fields['date_and_time']           = TextField(self, 0.65 , 0.9   , 0.325, 0.075 , datetime.now().strftime('%A, %B %d; %I:%M %p'), None, BLACK, None , 'OpenSans-Regular', 24 , None, True , False, False, 'right' , 'bottom')
                self.text_fields['basic_scores']            = TextField(self, 0.025, 0.625 , 0.6  , 0.35  , '...'                                         , None, BLACK, BLACK, 'OpenSans-Regular', 42 , None, True , False, True , 'center', 'center')

            else:
                raise NameError('State passed to GUI at start of question does not exist') # StateNotFound
    ...
    def update_state(self, new_state):
        ...
        if new_state in GAME_STATES:
            ...
            if self.state == 'ReaderAsking':
                ...
                self.text_fields.get('question_text').change_size_with_state(self, 0.025, 0.2, 0.6, 0.375)
...
class TextField:
    ...
    def __init__(self, gui, x, y, width, height, text, background_clr, text_clr, outline_clr, font_name, font_size, input_text_on_click, is_visible, show_background, show_outline, horz_algnmt, vert_algnmt):
        ...
        self.font = pygame.font.SysFont(self.get_font_filepath(self.font_name), self.font_size)
    ...
    def get_font_filepath(self, ttf_filename):
        out = os.path.join('Resources', 'Fonts', ttf_filename + '.ttf')
        return out
...
class MultiField:
    ''' Creates & renders a serious of TextField objects to create multiline question and answer fields '''
